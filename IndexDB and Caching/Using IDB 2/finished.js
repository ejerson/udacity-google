...
IndexController.prototype._showCachedMessages = function() {
  ...
  return this._dbPromise.then(function(db) {
    ...
    return index.getAll().then(function(messages) {
        // pass each messaage to addPost method
        // .reverse is used to reverse the order of the messages
        // the default is assending rather than getting the most recent message first
